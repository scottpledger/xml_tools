...
Run `bazel run //tools/gazelle:gazelle` to keep them up-to-date.

## Using this as a development dependency of other rules

You'll commonly find that you develop in another WORKSPACE, such as
some other ruleset that depends on xml.bzl, or in a nested
...
```sh
OVERRIDE="--override_repository=xml.bzl=$(pwd)/xml.bzl"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@xml.bzl` on your system will point to this folder.
...
https://github.com/scottpledger/xml.bzl/actions/workflows/tag.yaml
