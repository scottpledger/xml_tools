...
some other ruleset that depends on xml_tools, or in a nested
...
```sh
OVERRIDE="--override_repository=xml_tools=$(pwd)/xml_tools"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@xml_tools` on your system will point to this folder.
...
https://github.com/scottpledger/xml_tools/actions/workflows/tag.yaml
