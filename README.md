...
1. search for "xml_tools" and replace with the name you'll use for your workspace
1. search for "scottpledger" and replace with GitHub org
...
<https://github.com/scottpledger/rules_mylang/releases>
...
1. Replace `url = "https://github.com/scottpledger/rules_mylang/releases/download/v0.1.0/rules_mylang-v0.1.0.tar.gz"` with a GitHub-provided source archive like `url = "https://github.com/scottpledger/rules_mylang/archive/abc123.tar.gz"`
